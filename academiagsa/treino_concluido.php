...
<head>
    ...
    <title>Resumo do Treino | Overload</title>
    <style>
        ...
        .btn { width: 100%; padding: 18px; background: var(--accent); border: none; border-radius: 15px; font-weight: bold; cursor: pointer; color: #000; font-size: 1rem; transition: 0.3s; }
...
<body>
    <div class="container">
        ...
        <h1 style="color: var(--accent); margin: 0; font-size: 1.8rem;">Treino Pago!</h1>
        <p style="color: var(--gray); margin-top: 5px;">Missão cumprida, <?= explode(' ', $aluno['nome'])[0] ?>!</p>
        ...
        <div class="stats-box">
            ...
            <div class="stat-item">
                <div class="stat-label">Energia Gasta</div>
                <div class="stat-value"><?= number_format($kcal_estimado, 1, ',', '.') ?> <small style="font-size: 0.9rem;">kcal</small></div>
            </div>
        </div>

        <button class="btn" onclick="window.location.href='painel_aluno.php'">CONCLUIR</button>
    </div>
</body>
</html>