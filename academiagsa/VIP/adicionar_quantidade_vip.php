...
$fibr       = (float)($_GET['fibr'] ?? 0); // <-- NOVA LINHA: Captura a fibra
...
$fibr_final = $fibr * $fator; 

try {
    $sql = "INSERT INTO alimentos (nome, porcao_referencia, kcal, proteina, carbo, gordura, fibra, usuario_id, data_registro) 
            VALUES (:nome, :porcao, :kcal, :prot, :carb, :gord, :fib, :user_id, NOW())";
